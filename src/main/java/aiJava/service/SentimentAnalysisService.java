...
//			String[] newReviews = {"Product is amazing", "Worst experience","the product is very good","the product is worst","the product is bad","bad experience","very clean"};
//
